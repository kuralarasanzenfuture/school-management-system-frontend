...
//   // Global Ctrl/⌘+K opens the module search overlay from anywhere.
//   useEffect(() => {
...
//       {/* ── Right: actions ── */}
//       <div className="flex items-center gap-2">
//         {/* Search trigger — hidden on small screens. Typing actually
//             happens in QuickSearchOverlay's own input; this is just the
//             entry point (click, focus, or Ctrl/⌘+K from anywhere). */}
//         <button
//           onClick={() => setSearchOpen(true)}
//           className="hd-search-wrap hidden lg:flex items-center gap-2 rounded-lg px-3 py-2 w-56"
//         >
//           <Search size={14} className="hd-search-icon shrink-0" />
//           <span className="hd-search-input text-[13.5px] text-left flex-1">
//             Search…
//           </span>
//           <span className="hd-search-kbd hidden xl:inline-flex px-1.5 py-0.5 rounded text-[10.5px] font-medium shrink-0">
//             {navigator.platform?.toUpperCase().includes("MAC") ? "⌘K" : "Ctrl K"}
//           </span>
//         </button>

//         {/* Search trigger — icon-only on small/medium screens */}
//         <button
//           onClick={() => setSearchOpen(true)}
//           className="hd-icon-btn lg:hidden w-9 h-9 rounded-lg flex items-center justify-center"
//           title="Search"
//         >
//           <Search size={17} />
//         </button>
...
const Header = () => {
  ...
  return (
    <header className="hd-header flex items-center justify-between px-5 sm:px-6">
      ...
      {/* ── Right: actions ── */}
      <div className="flex items-center gap-2">
        {/* Module/page launcher — icon trigger + its own anchored dropdown */}
        <ModuleLauncher />

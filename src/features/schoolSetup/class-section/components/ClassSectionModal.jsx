...
export default function ClassSectionModal({
  ...
  return (
    ...
    >
      <div
        className="cs-modal-panel w-full max-w-md rounded-2xl overflow-hidden flex flex-col max-h-[90vh]"
        onClick={(e) => e.stopPropagation()}
      >
        {/* Fixed Header */}
        <div className="cs-modal-header sticky top-0 z-10 flex items-center justify-between px-6 py-4">
          <h2 className="cs-modal-title text-[16px] font-bold">
            {classSection ? "Edit Class Section" : "Add Class Section"}
          </h2>

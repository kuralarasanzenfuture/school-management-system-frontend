...
import SubjectGroupTable from "../components/SubjectGroupTable.jsx";
import SubjectGroupModal from "../components/SubjectGroupModal.jsx";
import DeleteSubjectGroupModal from "../components/DeleteSubjectGroupModal.jsx";
import StatusFilterDropdown from "../components/StatusFilterDropdown.jsx";
import {
  fetchSubjectGroups,
  createSubjectGroupThunk,
...
const SubjectGroupPage = () => {
  ...
  // SubjectGroupTable calls onDelete(id) — matching every other table in
  // this app. DeleteSubjectGroupModal needs the full record (name) to
  // show a meaningful confirmation, so look it up here rather than
  // changing the table's contract. Same fix applied to every other
  // module's page.
  const openDeleteModal = (id) => {
    const group = subjectGroups.find((sg) => String(sg.id) === String(id));

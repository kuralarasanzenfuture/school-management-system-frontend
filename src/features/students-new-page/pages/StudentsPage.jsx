...
export default function StudentsPage() {
  ...
  // Add/Edit now live on their own routes instead of a modal.
  const openAddModal = () => navigate("/students/add");
  const openEditModal = (student) => navigate(`/students/${student.id}/edit`);

...
export default function StudentsPage() {
  ...
  const filtered = useMemo(() => {
    ...
    return STUDENTS.filter((s) => s.cls.startsWith(cls));
  }, [activeTab]);
              ...
              {pageRows.map((s) => (
                ...
                >
                  ...
                  <td className="px-3 py-3.5">
                    <div className="flex items-center gap-3">
                      <div
                        className={`w-9 h-9 rounded-full flex items-center justify-center text-white text-[12px] font-bold shrink-0 ${s.color}`}
                      >
                        {s.initials}
                      </div>
                      <div>

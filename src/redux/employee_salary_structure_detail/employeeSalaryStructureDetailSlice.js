...
//       return rejectWithValue(
//         error.response?.data?.message ||
//           "Failed to fetch employee salary details",
//       );
//     }
//   },
// );
...
//   // Salary details of one employee
//   employeeDetailsByEmployee: [],
...
//     clearEmployeeDetailsByEmployee(state) {
//       state.employeeDetailsByEmployee = [];
//     },
...
//         state.employeeSalaryStructureDetails.unshift(newItem);
//         state.employeeDetailsByEmployee.unshift(newItem);
//       })
//       .addCase(addEmployeeSalaryStructureDetail.rejected, (state, action) => {
//         state.submitting = false;
//         state.error = action.payload;
...
//         const empIndex = state.employeeDetailsByEmployee.findIndex(
//           (item) => item.id === updated.id,
//         );

//         if (empIndex !== -1) {
//           state.employeeDetailsByEmployee[empIndex] = updated;
//         }
...
//           state.employeeDetailsByEmployee =
//             state.employeeDetailsByEmployee.filter(
//               (item) => item.id !== action.payload,
//             );

//           if (state.employeeSalaryStructureDetail?.id === action.payload) {
//             state.employeeSalaryStructureDetail = null;
//           }
//         },
//       )
...
// export const {
//   clearEmployeeSalaryStructureDetail,
//   clearEmployeeDetailsByEmployee,
//   clearEmployeeSalaryStructureDetailError,
// } = employeeSalaryStructureDetailSlice.actions;
